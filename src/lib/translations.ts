...
const translations = {
  hi: {
    ...
    otherServicesPage: {
        title: "हमारी सभी सेवाएं",
        description: "आपको कौन सी स्वास्थ्य सेवा चाहिए?",
        findDoctor: "डॉक्टर खोजें",
        findDoctorDesc: "सही विशेषज्ञ ढूंढें और तुरंत अपॉइंटमेंट बुक करें।",
        homeVisit: "डॉक्टर होम विज़िट",
        homeVisitDesc: "आराम से अपने घर पर डॉक्टर से परामर्श लें।",
  ...
  en: {
    ...
    otherServicesPage: {
        ...
        description: "Which healthcare service do you need?",
        findDoctor: "Find a Doctor",
        findDoctorDesc: "Find the right specialist and book an appointment instantly.",
        homeVisit: "Doctor Home Visit",
        homeVisitDesc: "Get consulted by a doctor in the comfort of your home.",
        medicineDelivery: "Medicine Delivery",
        medicineDeliveryDesc: "Have your medications delivered right to your doorstep.",
        ...
        tbTreatment: "TB Treatment Support",
  ...
  bho: {
    ...
    otherServicesPage: {
        title: "हमनी के सब सेवा",
        description: "रउआ के कवन स्वास्थ्य सेवा चाहीं?",
        findDoctor: "डॉक्टर खोजीं",
        findDoctorDesc: "सही विशेषज्ञ खोजीं आ तुरंत अपॉइंटमेंट बुक करीं।",
        homeVisit: "डॉक्टर होम विजिट",
        homeVisitDesc: "आराम से आपन घरे डॉक्टर से सलाह लीं।",
